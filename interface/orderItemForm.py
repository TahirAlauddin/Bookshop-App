...
# Form implementation generated from reading ui file 'orderItemForm.ui'
#
...
"}")
        ...
        self.gridLayout.addWidget(self.input_quantity, 5, 2, 1, 1)
        ...
        self.comboBox_bookid = QtWidgets.QComboBox(self.frame_2)
        font = QtGui.QFont()
        ...
        font.setWeight(50)
        self.comboBox_bookid.setFont(font)
        self.comboBox_bookid.setObjectName("comboBox_bookid")
        self.gridLayout.addWidget(self.comboBox_bookid, 3, 2, 1, 1)
        self.comboBox_orderId = QtWidgets.QComboBox(self.frame_2)
        self.comboBox_orderId.setObjectName("comboBox_orderId")
        self.gridLayout.addWidget(self.comboBox_orderId, 4, 2, 1, 1)
...
"QPushButton:pressed { background-color: rgb(23, 26, 30); border-style: solid; border-radius: 4px; }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Book"))
